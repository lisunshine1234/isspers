...
function renderAlgorithmFileListInPage(path) {
    $.ajax({
        async: true,
        url: "/guteam/admin/algorithm/my/getAlgorithmFileList",
        type: "POST",
        data: {"path": path},
        dataType: "json",
        beforeSend: function () {
...
function saveBaseInfo() {
    $.ajax({
        async: true,
        url: "/guteam/admin/algorithm/my/save/baseInfo",
        type: "POST",
...
function saveInputListAndOutputList() {
    $.ajax({
        async: true,
        url: "/guteam/admin/algorithm/my/save/inputListAndOutputList",
        type: "POST",
...
function saveDisplay() {
    ...
    $.ajax({
        async: true,
        url: "/guteam/admin/algorithm/my/save/displayList",
        type: "POST",
...
function getRunEnvironmentAndEngine(json) {
    $.ajax({
        async: true,
        url: "/guteam/admin/algorithm/my/add/getEnvironmentAndEngine",
        type: "POST",
...
function fileuploadRender() {
    $('#fileList').fileupload({
            type: 'POST',
            url: '/guteam/admin/algorithm/my/upload',
            dataType: 'json',
            autoUpload: false,
...
function delFileListAtServer(fileNameList) {
    $.ajax({
        async: true,
        url: "/guteam/admin/algorithm/my/delFileList",
        type: "POST",
...
function delFileAtServer(fileName) {
    $.ajax({
        async: true,
        url: "/guteam/admin/algorithm/my/delFile",
        type: "POST",
...
function uploadRunAndInputAndOutput() {
    $.ajax({
        async: true,
        url: "/guteam/admin/algorithm/my/getAlgorithmMethodList",
        type: "POST",
