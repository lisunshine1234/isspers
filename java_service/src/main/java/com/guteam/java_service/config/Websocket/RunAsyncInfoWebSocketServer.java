...
@ServerEndpoint("/webSocket/algorithm/run/async/{jobId}")
@Component
public class RunAsyncInfoWebSocketServer {
    @Autowired
    private static JobService jobService;
    @Autowired
    private static RedisUtil2 redisUtil2;

    private static final String loggerName = RunAsyncInfoWebSocketServer.class.getName();
...
//            e.printStackTrace();
    ...
    public void setChatService(JobService jobService, RedisUtil2 redisUtil2) {
        RunAsyncInfoWebSocketServer.jobService = jobService;
        RunAsyncInfoWebSocketServer.redisUtil2 = redisUtil2;
    }
}
