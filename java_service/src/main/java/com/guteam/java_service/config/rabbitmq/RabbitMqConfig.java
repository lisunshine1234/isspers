package com.guteam.java_service.config.rabbitmq;
...
public class RabbitMqConfig {
    ...
    SimpleRabbitListenerContainerFactory container(ConnectionFactory connectionFactory) {
        ...
        simpleRabbitListenerContainerFactory.setErrorHandler(t -> logger.error("listener error!", t));
